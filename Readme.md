...
<svg xmlns="http://www.w3.org/2000/svg" width="480" height="89" class="">
    <defs>
        <style/>
    </defs>
    <style>
        ...
        <div xmlns="http://www.w3.org/1999/xhtml" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <section class="column">
                ...
                <svg class="bar" xmlns="http://www.w3.org/2000/svg" width="460" height="8">
                    ...
                    <rect mask="url(#languages-bar)" x="0" y="0" width="296.9928067963372" height="8" fill="#f1e05a"/>
                    <rect mask="url(#languages-bar)" x="296.9928067963372" y="0" width="81.47216652771749" height="8" fill="#f34b7d"/>
                    <rect mask="url(#languages-bar)" x="378.46497332405477" y="0" width="35.930517373240455" height="8" fill="#a91e50"/>
                    <rect mask="url(#languages-bar)" x="414.39549069729526" y="0" width="27.241422472101075" height="8" fill="#dad8d8"/>
                    <rect mask="url(#languages-bar)" x="441.6369131693963" y="0" width="9.96359761237084" height="8" fill="#3572A5"/>
                    <rect mask="url(#languages-bar)" x="451.6005107817672" y="0" width="5.110556462744396" height="8" fill="#2b7489"/>
                    <rect mask="url(#languages-bar)" x="456.7110672445116" y="0" width="1.8109269173263884" height="8" fill="#555555"/>
                    <rect mask="url(#languages-bar)" x="458.52199416183794" y="0" width="1.4780058381621042" height="8" fill="#2c3e50"/>
                </svg>
                <div class="field center horizontal-wrap fill-width">
                    ...
                    <div class="field center no-wrap language">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="16" height="16">
                            <path fill="#dad8d8" fill-rule="evenodd" d="M8 4a4 4 0 100 8 4 4 0 000-8z"/>
                        </svg>
                        PLSQL
                    </div>
                    <div class="field center no-wrap language">
                    ...
                    <div class="field center no-wrap language">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="16" height="16">
                            <path fill="#2c3e50" fill-rule="evenodd" d="M8 4a4 4 0 100 8 4 4 0 000-8z"/>
                        </svg>
                        Vue
                    </div>
                </div>
